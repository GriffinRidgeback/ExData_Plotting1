...
#
# This file creates plot4.png according to the plot given in the assignment
...
#
# save the global graphics environment
old_par <- par(no.readonly = T)

# open the PNG device
png( "plot4.png")

# configure a 2x2 plot area
par(mfcol = c(2, 2))
...
legend("topright", lty = 1, bty = "n", col = c("black", "red", "blue"), legend = names(data)[7:9])
